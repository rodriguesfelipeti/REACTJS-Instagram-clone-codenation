...
const Post = ({ postInfo, userInfo }) => {
  const [follow, toogleFollow] = useState(false)
    ...
    <article className="post" data-testid="post">
      ...
      {userInfo &&
        <header className="post__header">
            ...
            <button className="post__context" onClick={() => toogleFollow(!follow)}>
              {follow
      ...
      <figure className="post__figure"><img src={imageUrl} alt="" /></figure>
      {userInfo && (
